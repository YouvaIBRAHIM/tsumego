import { ITsumegoProblem, ITsumegoProblemList, ITsumegoProblemSearch } from "@src/types/tsumego.type";

const BACKEND_BASE_URL = import.meta.env.BACKEND_BASE_URL

const problems: ITsumegoProblem[] = [
    {
      id: "sdmffkds",
      label: "Problem0001",
      level: "easy",
...
export const getProblems = async (page: number, perPage: number, search: ITsumegoProblemSearch) => {
    try {
        ...
        return new Promise<ITsumegoProblemList>((resolve) => {
            resolve({
