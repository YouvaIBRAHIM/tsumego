...
export const getProblems = async (
  ...
  try {
    ...
    throw new Error(
      "Une erreur est survenue lors du chargement des problèmes. Veuillez réessayer.",
    )
  }
}
...
export async function deleteProblem(id: string) {
  try {
    ...
    throw new Error(
      "Une erreur est survenue lors de la suppression du problème. Veuillez réessayer.",
    )
  }
}
...
type IProblemCreateResponse = Promise<
  [Response["status"], IProblemCreate | IErrorCreateProblem]
>

export const createProblem = async (
  data: IProblemCreate,
): IProblemCreateResponse => {
  const csrfToken = await getCsrfToken()
...
export async function getProblem(id: string): Promise<IProblem> {
  ...
  try {
    ...
    return Promise.reject(
      "Une erreur est survenue lors du chargement du problème. Veuillez réessayer.",
    )
  }
}
...
export async function updateProblemStatus(id: string) {
  try {
    ...
    const response = await fetch(
      `${BACKEND_BASE_URL}/api/problems/update/status/${id}/`,
      {
        method: "PUT",
        credentials: "include",
        headers: {
    ...
    throw new Error(
      "Une erreur est survenue lors de la mise à jour du status du problème. Veuillez réessayer.",
    )
  }
}
